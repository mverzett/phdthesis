...
% für Deutsch: erlaubt sind D, E, F, I
\usepackage{E}
...
% frontmatter
\frontmatter
\input{0_misc_headers/frontpage.tex} 
\input{0_misc_headers/abstract_DE.tex}
\cleardoublepage 
\input{0_misc_headers/abstract_EN.tex}
%\cleardoublepage 
%\input{0_misc_headers/aknoledgments.tex}
\cleardoublepage 
...
% mainmatter
\mainmatter
\input{1_Introduction_Th_and_Exp/chap.tex}
\input{2_LHC_and_CMS/chap.tex}
\input{3_Evt_Reconstruction/chap.tex}
\input{4_Analisys/chap.tex}
\input{5_Conclusions_and_Outlook/chap.tex}

\appendix
\cleardoublepage 
\input{6_Appendixes/Appendix.tex}
\cleardoublepage 
%\input{Appendice1.tex}          % ï¿½ facoltativo

% backmatter
\backmatter
\bibliographystyle{lucas_unsrt} %ieeetr} %plain}
\markboth{Bibliography}{Bibliography}
%\fancyhead[RE]{\small \slshape Bibliography}
...
%\input{elencoacronimi.tex}      % ï¿½ facoltativo
%\printindex                     % Indice analitico ï¿½ facoltativo
