...
Measured and simulated kinematic distributions are compared in dedicated control regions with $\Z\To\mu\mu,e\mu,ee$ decays. %This comparison is shown in Section XX.
...
Table \ref{tab:pulls} summarizes the largest pulls observed in the ML fit to the data.
