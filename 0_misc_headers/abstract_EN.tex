...
%The search excludes the presence of a SM Higgs boson with more than 2.5 times its expected cross section. The observed exclusion limit is consistent within $2\sigma$ from the  background--only hypothesis. 