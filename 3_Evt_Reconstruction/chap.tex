...
Events passing the previous selection are then divided into six mutually-exclusive categories (A, B, C1p, C1f, C2, D) according to the following event properties:
\begin{itemize}
